...
**IMPORTANT**: Always consult the personas defined in `team.md` when making decisions about course content, structure, materials, and documentation. The personas provide context for:
- Course design philosophy and priorities
- Teaching approach and communication style
- Technical preferences and standards
- Student expectations and learning objectives

The `team.md` file contains detailed information about the professor's teaching philosophy, technical preferences, and course structure preferences. Refer to it regularly to ensure alignment with course goals.

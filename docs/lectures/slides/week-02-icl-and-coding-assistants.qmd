...
### Adoption
Major retailers: Coach, Kate Spade, URBN, Revolve, Ashley Furniture
Platforms: Squarespace, Wix, Etsy, WooCommerce, BigCommerce

Source: [Stripe Agentic Commerce Suite](https://stripe.com/newsroom/news/agentic-commerce-suite)
...
Source: [Cursor Statistics 2025](https://devgraphiq.com/cursor-statistics/)
...
|--------------|-----------------------------------|
| Amazon Nova | [docs.aws.amazon.com/nova](https://docs.aws.amazon.com/nova/latest/userguide/prompting.html) |
| Anthropic Claude | [docs.anthropic.com](https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering/) |
| Meta LLaMA | [llama.com/docs](https://www.llama.com/docs/how-to-guides/prompting/) |
...
### Other Tools
- [Cursor](https://cursor.com) | [Cursor Statistics](https://devgraphiq.com/cursor-statistics/)
- [AWS Kiro](https://kiro.dev/) | [Kiro CLI Docs](https://kiro.dev/cli/)
...
- [Stripe Agentic Commerce Suite](https://stripe.com/newsroom/news/agentic-commerce-suite) (Dec 2025)
- [Notion 3.0: Agents](https://www.notion.com/releases/2025-09-18) (Sep 2025)
- [Cursor Adoption Trends](https://opsera.ai/blog/cursor-ai-adoption-trends-real-data-from-the-fastest-growing-coding-tool/)
